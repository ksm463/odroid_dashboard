...
def send_telegram(sensor_state, sensor_data):
    ...
    if sensor_state == "very_high_temp":
        message = f"경고: 온도 {sensor_data.temperature}°C가 매우 높습니다."
    elif sensor_state == "high_temp":
        message = f"경고: 온도 {sensor_data.temperature}°C가 비정상 범위에 진입했습니다."
    elif sensor_state == "low_humidity":
        message = f"주의: 습도 {sensor_data.humidity}%가 낮습니다."
    elif sensor_state == "high_humidity":
        message = f"주의: 습도 {sensor_data.humidity}%가 높습니다."
